<div class="card">
    ...
    <div class="card-body">
        <?php echo form_open('edit-case/'.$tax_return_client['id'],array("class"=>"form-horizontal")); ?>
        <div class="row" id="addmore">
            ...
            <div class="col-md-4">
                <label for="email_password" class=" control-label">Email Password</label>
                    <input type="password" name="email_password" class="form-control" id="email_password" />
            ...
            <div class="col-md-4">
                <label for="dob" class=" control-label"><span class="text-danger">*</span>Date of Birth</label>
                    <input type="Date" name="dob" value="<?php echo ($this->input->post('dob') ? $this->input->post('dob') : $tax_return_client['dob']); ?>" class="form-control" id="dob" />
...
<script type="text/javascript">
    let count=<?=count($tax_return_client['feilds'])?>;
    $(function() {
