        ...
        <div style="min-width: 600px">
            <header style="background-color: white">
                <div class="row">
                    <div class="col-md-3">
                        <a target="_blank" >
                            <img style="width:200px; height:200px" src="<?php echo base_url('assets/images/HORIZON LOGO BLACK TAGLINE.png');?>" data-holder-rendered="true" />
                            </a>
                    </div>
 ...
 <td  style="background: none" colspan="2"><?php echo  $services['service_type_name']; ?></td> 
   ...
   <tr style="margin-top: 60px">
    ...
    <td colspan="2" style="text-align: left; font-family: 'Roboto', sans-serif; border: none;"><strong>PASSENGER NOTE:</strong> <?php echo  $services['pass_note']; ?></td>
                      ...
                      <?php echo form_open('View_request/update_status/'.$services['id'],array("class"=>"form-horizontal")); ?>
                        <tr>
                            <td colspan="2"></td>
                            <td>
